...
$APPLICATION->SetTitle("Hовинки");
$APPLICATION->SetPageProperty('title', 'Hовинки');
$APPLICATION->SetPageProperty('description', 'Hовинки');
$APPLICATION->AddChainItem('Каталог', '/catalog/');
$APPLICATION->AddChainItem('Hовинки');
			...
			<div class="sort-wrap">
				...
				<? $APPLICATION->IncludeComponent(
					...
					array(
						...
						"CURRENCY_ID"           => null,
						"SEF_MODE" => "N",
						"SEF_RULE"              => "/catalognew/filter/#SMART_FILTER_PATH#/",
...
//									$selected = 'selected="selected"';
	...
	array(
		...
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":{\"1\":{\"CLASS_ID\":\"CondIBProp:26:200\",\"DATA\":{\"logic\":\"Equal\",\"value\":48626}}}}",
		"LABEL_PROP_MOBILE" => "",
