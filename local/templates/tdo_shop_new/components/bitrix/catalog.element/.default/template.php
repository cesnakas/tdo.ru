					...
					if($QUANTITY)
					{
						...
						<div id="pay-click" class="pay-click modal js-pay-click" style="display: none;">
							<div class="call-me-inner">
								...
								<form class="call-me-content js-pay-one-click-form" action="/ajax/ajax.php" method="post">
									...
									<div class="polit-conf">
										...
										<label for="polit44">Отправляя свои данные, вы соглашаетесь <br><a href="/about/politika-konfidencialnosti/">Политикой
								...
								<form class="call-me-content js-pay-credit-form" action="/ajax/ajax.php" method="post">
									...
									<div class="polit-conf">
										...
										<label for="polit-credit">Отправляя свои данные, вы соглашаетесь <br><a
													href="/about/politika-konfidencialnosti/">Политикой
												конфиденциальности</a></label>
									</div>
								</form>
							</div>
