...
$APPLICATION->SetPageProperty("ISELEMENT_INCATALG",1);
//$APPLICATION->SetPageProperty("ISELEMENT_INCATALG");
//die("asd");
...
{
	case 'forshop':
		$titleVariant = 'catalog_banner_forshop';
		break;
	case 'forkafe':
		$titleVariant = 'catalog_banner_forkafe';
		break;
	default:
		$titleVariant = 'catalog_banner';
		break;
}
...
?>
	...
	<div class="pagination-mob">
		<div class="container">
			<a class="pagination-mob_link" href="/catalog/">Каталог оборудования</a>
		</div>
	</div>
	...
	<div class="catalog">
		...
		<? $APPLICATION->IncludeFile(
			$APPLICATION->GetTemplatePath("/include/" . $titleVariant . ".php"),
			array(),
			array('MODE' => 'html')
		); ?>
		...
		<div class="catalog-wrap">
			<div class="container">
				...
				//			$sectionListParams["SECTION_ID"] = 93;
