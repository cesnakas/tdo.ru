...
<div class="good-page">
	...
	$IBLOCK_SECTION_ID = 0;
	$res               = CIBlockElement::GetByID($GLOBALS['CATALOG_CURRENT_ELEMENT_ID']);// $_GET["PID"] - ID элемента.
	...
	<? $APPLICATION->IncludeComponent(
		...
		array(
			...
			"IBLOCK_ID"                  => $componentElementParams['IBLOCK_ID'],
			...
			"PROPERTY_CODE"              => array(0 => "", 1 => "HIT", 2 => "NEW", 3 => "STOCK", 4 => "RECOMMEND", 5 => "SECTION_CODE",),
	...
	if(!empty($recommendedData)) {
		//Блок: Рассмотрите также аналоги этого товара
...
//			$arrFilter['PROPERTY_VYGRUZHAT_NA_SAYT_VALUE'] = 'Да';
		...
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				"IBLOCK_ID"                       => "45",    // Код информационного блока
