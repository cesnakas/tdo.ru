...
foreach ($this->basketItems as $row)
{
	...
	$arPrices = $price_result->Fetch();

//	$price_save = $arPrices['PRICE'] - $row['PRICE'];
	...
	$rowData = array(
		...
		'PRICE_FORMATED_OLD' => CurrencyFormat($arPrices['PRICE'], $arPrices['CURRENCY']),
		'PRICE_SAVE' => $price_save,
		'PRICE_SAVE_FORMATED' => CurrencyFormat($price_save, $arPrices['CURRENCY']),
		'PRICE' => $row['PRICE'],
