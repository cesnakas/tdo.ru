...
?>
<div class="row news-list-rows news-list<?=$themeClass?>">
	<div class="col">
		...
		<div class="row">
			<? foreach ($arResult["ITEMS"] as $arItem): ?>
				...
				?>
				<div class="news-list-item mb-2" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
					<div class="card">
						...
						<div class="card-body">
							...
							<? foreach ($arItem["FIELDS"] as $code => $value): ?>
								...
								<? elseif(
									...
									<?
									$value = CIBlockFormatProperties::DateFormat($arParams["ACTIVE_DATE_FORMAT"],
									                                             MakeTimeStamp($value,
									                                                           CSite::GetDateFormat()));
									?>
									<div class="news-list-view news-list-post-params">
							...
							<div class="d-flex justify-content-between align-items-center">
								...
								<? if($arParams["USE_SHARE"] == "Y")
								{
									...
									<div class="text-right">
										<?
										$APPLICATION->IncludeComponent("bitrix:main.share", $arParams["SHARE_TEMPLATE"],
										                               array(
