...
$res = CIBlockElement::GetList(Array(), Array("IBLOCK_ID"=>26, "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y", 'PROPERTY_BRANDS_NAME_VALUE'=>$item['NAME'], "PROPERTY_VYGRUZHAT_NA_SAYT_VALUE" => 'Да'), false, false, Array("ID", "NAME", "PROPERTY_BRANDS_NAME"));
while($ob = $res->fetch()){
	if(strcasecmp($item['NAME'], $ob['PROPERTY_BRANDS_NAME_VALUE']) == 0){
$arResult['CNT_ARR'][] = $ob['PROPERTY_BRANDS_NAME_VALUE']; 
}
}
}
$arResult['CNT_ARR'] = array_flip($arResult['CNT_ARR']);
