...
$MESS["1CB_PARAMETER_ELEMENT_CODE"] = "Символьный код контейнера товара";
$MESS["1CB_PARAMETER_ELEMENT_PROPS"] = "Свойства товара";
$MESS["1CB_PARAMETER_REQUIRED_ORDER_FIELDS"] = "Обязательные поля формы заказа";
$MESS["1CB_PARAMETER_REQUIRED_ORDER_FIELDS_NAME"] = "Имя";
$MESS["1CB_PARAMETER_REQUIRED_ORDER_FIELDS_TEL"] = "Телефон";
$MESS["1CB_PARAMETER_REQUIRED_ORDER_FIELDS_EMAIL"] = "Email";
$MESS["1CB_PARAMETER_REQUIRED_ORDER_FIELDS_MESSAGE"] = "Сообщение";
...
$MESS["1CB_PARAMETER_DEFAULT_AUTOMATICALLY"] = "Автоматический выбор";
$MESS["1CB_PARAMETER_BUY_MODE"] = "Режим покупки";
$MESS["1CB_PARAMETER_BUY_MODE_ONE"] = "Оформлять только выбранный товар";
$MESS["1CB_PARAMETER_BUY_MODE_ALL"] = "Оформлять все товары в корзине";
$MESS["1CB_PARAMETER_DUPLICATE_LETTER_TO_EMAILS"] = "Дублировать письмо о заказе на следующие адреса";
$MESS["1CB_PARAMETER_DUPLICATE_LETTER_TO_DEFAULT"] = "E-Mail адрес по умолчанию: ";
$MESS["1CB_PARAMETER_DUPLICATE_LETTER_TO_ADMIN"] = "E-Mail администратора сайта: ";
$MESS["1CB_PARAMETER_DUPLICATE_LETTER_TO_SALES"] = "E-Mail отдела продаж: ";
$MESS["1CB_PARAMETER_DUPLICATE_LETTER_TO_DUB"] = "E-mail(ы), на который дублируются все исходящие сообщения: ";
?>